<?php $__env->startSection('title', __('Enable Disable Category Section')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('Enable Disable Category Section')); ?></h4>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['class' => 'mt-5','description' => __('Notice: To keep the category section disabled on the frontend, make sure this remains disabled.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mt-5'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: To keep the category section disabled on the frontend, make sure this remains disabled.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <form action="<?php echo e(route('admin.category.enable.disable.settings')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="single-input my-5">
                                    <label class="label-title"><?php echo e(__('Enable/Disable Category Section For Home Page')); ?></label>
                                    <select name="category_section_enable_disable_for_homepage" class="form-control">
                                        ...
                                        <option value="enable" <?php if(get_static_option('category_section_enable_disable_for_homepage') == 'enable'): ?> selected <?php endif; ?>><?php echo e(__('Enable')); ?></option>
                                        <option value="disable" <?php if(get_static_option('category_section_enable_disable_for_homepage') == 'disable'): ?> selected <?php endif; ?>><?php echo e(__('Disabled')); ?></option>
                                    </select>
                                </div>
                                <div class="single-input my-5">
                                    <label class="label-title"><?php echo e(__('Enable/Disable Category Section For All Page')); ?></label>
                                    <select name="category_section_enable_disable" class="form-control">
                                        <option value=""><?php echo e(__('Enable-Disable')); ?></option>
                                        <option value="enable" <?php if(get_static_option('category_section_enable_disable') == 'enable'): ?> selected <?php endif; ?>><?php echo e(__('Enable')); ?></option>
                                        <option value="disable" <?php if(get_static_option('category_section_enable_disable') == 'disable'): ?> selected <?php endif; ?>><?php echo e(__('Disabled')); ?></option>
                                    </select>
                                </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clouddeployx.com/public_html/core/Modules/Service/Resources/views/settings/category-enable-disable.blade.php ENDPATH**/ ?>