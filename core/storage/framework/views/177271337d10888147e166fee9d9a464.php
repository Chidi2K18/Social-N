                        ...
                        <div class="sticky-sidebar">
                            <div class="project-preview">
                                <div class="project-preview-tab">
                                    <ul class="tabs">
                                        <li data-tab="basic" class="active"><?php echo e(__($project->basic_title)); ?></li>
                                        <li data-tab="standard" class="<?php if(empty($project->standard_title)): ?> pe-none <?php endif; ?>"><?php echo e(__($project->standard_title)); ?></li>
                                        <li data-tab="premium" class="<?php if(empty($project->premium_title)): ?> pe-none <?php endif; ?>"><?php echo e(__($project->premium_title)); ?></li>
                                    </ul>
                                            ...
                                            <?php if(Auth::guard('web')->check()): ?>
                                                ...
                                                <?php endif; ?>
                                                 ...
                                                 <?php if(Auth::guard('web')->user()->user_type == 2 && Auth::guard('web')->user()->id != $project->user_id && Session::get('user_role') == 'client'): ?>
                                                    <?php echo $__env->make('frontend.pages.project-details.freelancer-order-as-client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            <?php else: ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/frontend/pages/project-details/project-details.blade.php ENDPATH**/ ?>