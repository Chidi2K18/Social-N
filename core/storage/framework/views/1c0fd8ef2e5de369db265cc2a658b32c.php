                ...
                <span class="img_100">
                    <?php if($feedback?->user?->image): ?>
                        <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                            <img src="<?php echo e(render_frontend_cloud_image_if_module_exists( 'profile/'. $feedback?->user?->image, load_from: $feedback?->user?->load_from ?? '')); ?>" alt="<?php echo e(__('Profile Image')); ?>">
                        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/backend/pages/feedback/search-result.blade.php ENDPATH**/ ?>