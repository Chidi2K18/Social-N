<?php $__env->startSection('title', __('Enable Disable Profile Switch')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('Enable Disable Profile Switch')); ?></h4>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['class' => 'mt-5','description' => __('Notice: If you want to disable profile switch keep this disable.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mt-5'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: If you want to disable profile switch keep this disable.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <form action="<?php echo e(route('admin.profile.switch.settings')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="single-input my-5">
                                    <label class="label-title"><?php echo e(__('Enable/Disable Profile Switch')); ?></label>
                                    <select name="profile_switch_enable_disable" class="form-control">
                                        <option value=""><?php echo e(__('Enable-Disable')); ?></option>
                                        <option value="enable" <?php if(get_static_option('profile_switch_enable_disable') == 'enable'): ?> selected <?php endif; ?>><?php echo e(__('Enable')); ?></option>
                                        <option value="disable" <?php if(get_static_option('profile_switch_enable_disable') == 'disable'): ?> selected <?php endif; ?>><?php echo e(__('Disabled')); ?></option>
                                    </select>
                                </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/backend/pages/additional-settings/profile-switch-enable-disable-settings.blade.php ENDPATH**/ ?>