...
<div class="setup-wrapper-contents">
    ...
    <div class="setup-wrapper-contents-item">
        ...
        <ul class="setup-wrapper-work-list get_subcategory overflow-auto set_scroll_height">
			...
			$sub_categories  = \Modules\Service\Entities\SubCategory::where('category_id',$user_work->category_id)->get();?>
                <?php $__currentLoopData = $sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="setup-wrapper-work-list-item get_subcategory choose_a_subcategory <?php if(in_array($sub_cat->id,$subcategory_ids) && $user_work->user_id === $user_id): ?> active <?php endif; ?>" data-id="<?php echo e($sub_cat->id); ?>"><?php echo e($sub_cat->sub_category); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
...
<!-- Setup Work Ends -->
<?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/frontend/user/freelancer/account/work/work.blade.php ENDPATH**/ ?>