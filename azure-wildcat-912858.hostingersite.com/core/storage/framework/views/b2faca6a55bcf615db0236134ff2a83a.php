<?php $__env->startSection('title', __('Register Page Recaptcha Settings')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('Register Page Recaptcha Settings')); ?></h4>
                        </div>
...
<?php endif; ?>
                        <div class="customMarkup__single__inner mt-4">
                            <form action="<?php echo e(route('admin.page.settings.register.recaptcha')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="single-input mb-3">
                                    <label for="site_tag_line" class="label-title mb-1"><?php echo e(__('Recaptcha Site Key')); ?></label>
                                    <input type="text" name="recaptcha_site_key"  class="form-control" value="<?php echo e(get_static_option('recaptcha_site_key')); ?>">
                                </div>
                                <div class="single-input mb-3">
                                    <label for="site_tag_line" class="label-title mb-1"><?php echo e(__('Recaptcha Secret Key')); ?></label>
                                    <input type="text" name="recaptcha_secret_key"  class="form-control" value="<?php echo e(get_static_option('recaptcha_secret_key')); ?>">
                                </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/backend/pages/login-register-settings/register-recaptcha-settings.blade.php ENDPATH**/ ?>