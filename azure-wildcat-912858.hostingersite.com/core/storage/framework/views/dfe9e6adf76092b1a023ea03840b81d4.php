...
<?php endif; ?>
                ...
                <div class="modal-footer">
                    ...
                    <?php elseif(Auth::guard('web')->check() && Auth::guard('web')->user()->user_type == 2 && Session('user_role') == 'client'): ?>
                        <button type="submit" class="btn-profile btn-bg-1" id="order_now_only_for_load_spinner"><?php echo e(__('Order Now')); ?><span id="order_create_load_spinner"></span></button>
                    <?php else: ?>
                        <a href="<?php echo e(route('user.register')); ?>" target="_blank" class="btn-profile btn-bg-1"><?php echo e(__('Register as a client to continue')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </form>
...
<?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/frontend/pages/order/gateway-markup.blade.php ENDPATH**/ ?>