...
*/
  ...
  $(document).on('click', '.choose_a_subcategory', function () {
    const sub_category = String($(this).data('id'));

    if ($(this).hasClass('active2')) {
      $(this).removeClass('active2');
      selectedSubcategories = selectedSubcategories.filter(id => id !== sub_category);
    } else {
      $(this).addClass('active2');
      selectedSubcategories.push(sub_category);
    }

    $('#set_sub_category_id').val(selectedSubcategories.join(','));
            ...
            nextButton.addEventListener("click", function(e) {
                ...
                if (current <= Listings.length - 1) {
                    ...
                    // add experience
                        ...
                        $.ajax({
                                url: "<?php echo e(route('freelancer.account.social.add')); ?>",
                                type: 'post',
                                data: JSON.stringify(socialData),
                                success: function(res){
                                    if(res.status == 'ok'){
                                        toastr_success_js("<?php echo e(__('Socail Media Successfully Updated')); ?>");
                                    }
                                }
                            });
                    }
                    ...
                    // add skill
						...
						window.location.href = '/subscriptions/all'
                    }
                    // add hourly rate
                    else if(current == 6){
...
<?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/frontend/user/freelancer/account/account-setup-js.blade.php ENDPATH**/ ?>