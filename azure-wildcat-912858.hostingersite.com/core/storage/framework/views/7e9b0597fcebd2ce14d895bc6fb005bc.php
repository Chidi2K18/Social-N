        ...
        <div class="single-shop-left bg-white radius-10">
            <div class="single-shop-left-filter">
                <div class="single-shop-left-filter-flex flex-between">
                    ...
                    <a href="<?php echo e(route('projects.all')); ?>" class="single-shop-left-filter-reset"><?php echo e(__('Reset Filter')); ?></a>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/frontend/pages/projects/sidebar.blade.php ENDPATH**/ ?>