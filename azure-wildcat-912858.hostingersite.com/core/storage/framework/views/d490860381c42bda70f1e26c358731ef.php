                ...
                <div class="dashboard__promo bg-white">
                    <div class="dashboard__promo__row">
                        ...
                        <a href="<?php echo e(route('admin.client.all')); ?>" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    <span class="single_promo__subtitle"> <?php echo e(__('Total Businesses')); ?> </span>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u412525603/domains/azure-wildcat-912858.hostingersite.com/core/resources/views/backend/pages/dashboard/dashboard.blade.php ENDPATH**/ ?>