    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.add_length',function(){
                ...
                if(length == ''){
                    toastr_warning_js("<?php echo e(__('Length field is required !')); ?>");
                    return false;
                }
            });
            ...
            function lengths(page){
                $.ajax({
                    url:"<?php echo e(route('admin.length.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.length.search')); ?>",
                    method:'GET',
...
</script><?php /**PATH /home/clouddeployx.com/public_html/core/resources/views/backend/pages/length/length-js.blade.php ENDPATH**/ ?>