        ...
        <tr>
            ...
            <td>
                <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                    <img width="250" height="100" src="<?php echo e(render_frontend_cloud_image_if_module_exists('project/'.$project->image, load_from: $project->load_from)); ?>" alt="<?php echo e($project->title ?? ''); ?>">
                <?php else: ?>
                    <img width="250" height="100" src="<?php echo e(asset('assets/uploads/project/'. $project->image)); ?>" alt="<?php echo e($project->title); ?>">
                <?php endif; ?>
            </td>
            <td>
...
<?php endif; ?>
<?php /**PATH /home/u412525603/domains/azure-wildcat-912858.hostingersite.com/core/resources/views/backend/pages/project/search-result.blade.php ENDPATH**/ ?>