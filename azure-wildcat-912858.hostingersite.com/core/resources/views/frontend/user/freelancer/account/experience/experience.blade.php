...
<h4 class="setup-wrapper-contents-title-two">Social Media</h4>
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="url" class="form-control" id="facebook" name="facebook" value="{{ old('facebook', $user->facebook ?? '') }}" placeholder="https://facebook.com/your-profile">
        </div>

        <div class="col-md-6 mb-3">
            <label  class="label-title" for="twitter">Twitter</label>
            <input type="url" class="form-control" id="twitter" name="twitter" value="{{ old('twitter', $user->twitter ?? '') }}" placeholder="https://twitter.com/your-handle">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="url" class="form-control" id="linkedin" name="linkedin" value="{{ old('linkedin', $user->linkedin ?? '') }}" placeholder="https://linkedin.com/in/your-profile">
        </div>

        <div class="col-md-6 mb-3">
            <label  class="label-title" for="instagram">Instagram</label>
            <input type="url" class="form-control" id="instagram" name="instagram" value="{{ old('instagram', $user->instagram ?? '') }}" placeholder="https://instagram.com/your-profile">
        </div>
    </div>
